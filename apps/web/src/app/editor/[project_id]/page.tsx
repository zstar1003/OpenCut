...
export default function Editor() {
    ...
    const initProject = async () => {
      ...
      try {
        ...
        if (isProjectNotFound) {
          ...
          // For other errors (storage issues, corruption, etc.), log but don't create new project
  ...
  }, [projectId, loadProject, createNewProject, router]); // Removed activeProject?.id dependency
